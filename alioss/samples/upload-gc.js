...
var accessid  = "sKSFulcGCs7s4U0D",
    accesskey = "JKC0GiJRzHtcAmPH3uCkWnQAIzQUqw",
    hostVideo      = "https://mevideo.oss-cn-hangzhou.aliyuncs.com",
    chars     = '1234567890qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM';
videofile = new Date();
videofile = ''+videofile.getFullYear()+(videofile.getMonth() + 1)+videofile.getDate() + 'GC';
for (var i = 0 ; i <= 28 ; i++){
	videofile += chars[parseInt(Math.random()*62)];
}
...
var uploaderVideo = new plupload.Uploader({
	...
	container: document.getElementById('containerVideo'),
	flash_swf_url : 'lib/plupload-2.1.2/js/Moxie.swf',
	silverlight_xap_url : 'lib/plupload-2.1.2/js/Moxie.xap',
    url : 'https://oss.aliyuncs.com',
	filters: {
		mime_types : [ //只允许上传图片和zip文件
			{ title : "Video files", extensions : "mp4,avi,mov,3gp,mkv,rmvb,flv,mpg,mts" }
		],
...
//			d.getElementsByTagName('b')[0].innerHTML = '<span>' + file.percent + "%</span>";
			...
			if (file.percent == 100){
				document.getElementById('videoPrecent').innerHTML = '上传完成,可以发布!';
			}
		},
...
//				document.getElementById(file.id).getElementsByTagName('b')[0].innerHTML = '上传成功, <br />视频网址:' + hostVideo+"/"+ filename;
//				document.getElementById(file.id).getElementsByTagName('b')[0].innerHTML = '视频上传成功, <br />视频转码后的网址'+ hostVideo+ '/transcode/'+videofile+'.mp4 <br />截图网址'+ hostVideo+'/snapshots/'+videofile+'.jpg';

//				document.getElementById("zhuanma").innerHTML='<b style="color:#F00">服务器处理转码中...</b>';
	            document.getElementById('titlepic').value = hostVideo + '/snapshots/'+videofile+'.jpg';
	            document.getElementById('downpath1').value = hostVideo + '/transcode/'+videofile+'.mp4';
...
//                document.getElementById(file.id).getElementsByTagName('b')[0].innerHTML = info.response;
	            document.getElementById('videoPrecent').innerHTML = '上传完成,可以发布,后台正在转码!';
            } 
		},
